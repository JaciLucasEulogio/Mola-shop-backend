...
import com.lucas.repository.AddressRepository;
import com.lucas.repository.CartRepository;
...
public class OrderServiceImplementation implements OrderService{
	...
	public Order findOrderById(Long orderId) throws OrderException {
		...
		throw new OrderException("order not exist whit id:"+orderId);
	}
	...
	public Order placedOrder(Long orderId) throws OrderException {
		...
		//order.getPaymentDetails().setStatus(PaymentSatus.COMPLETED);
