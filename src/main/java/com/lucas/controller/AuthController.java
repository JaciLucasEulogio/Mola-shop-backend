...
import com.lucas.request.LoginRequest;
import com.lucas.response.AuthResponse;
import com.lucas.service.CartService;
import com.lucas.service.CustomUserServiceImplementation;
...
public class AuthController {
	...
	public ResponseEntity<AuthResponse>createUserHandler(@RequestBody User user) throws UserException{
		...
		if(isEmailExist!=null) {
			throw new UserException("Email is Alredy Used Whit Another Account");
		}
